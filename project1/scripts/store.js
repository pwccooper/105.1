...
document.getElementById('owners').innerHTML=`<h2>Here's the current pet customers we have: <br> ${pet1.name} - Owner: ${pet1.ownerName} <br> ${pet2.name} - Owner: ${pet2.ownerName} <br>`;
